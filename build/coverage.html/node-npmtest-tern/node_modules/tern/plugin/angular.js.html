...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-tern/node_modules/tern/plugin/angular.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-tern/node_modules/tern/plugin/angular.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-tern/node_modules/tern/plugin/</a> &#187; angular.js</div>
</div>
<div class="body">
...
1021
1022
1023</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cstat-no" title="statement not covered" >    return define(["../lib/infer", "../lib/tern", "../lib/comment", "acorn/dist/walk"], mod);</span>
<span class="cstat-no" title="statement not covered" >  mod(tern, tern, tern.comment, acorn.walk);</span>
})(function(infer, tern, comment, walk) {
  "use strict";
&nbsp;
  var SetDoc = infer.constraint({
    construct: <span class="fstat-no" title="function not covered" >function(doc) {</span> <span class="cstat-no" title="statement not covered" >this.doc = doc; </span>},
    addType: <span class="fstat-no" title="function not covered" >function(type) {</span>
<span class="cstat-no" title="statement not covered" >      if (!type.doc) <span class="cstat-no" title="statement not covered" >type.doc = this.doc;</span></span>
    }
  });
&nbsp;
<span class="fstat-no" title="function not covered" >  function Injector() {</span>
<span class="cstat-no" title="statement not covered" >    this.fields = Object.create(null);</span>
<span class="cstat-no" title="statement not covered" >    this.forward = [];</span>
  }
&nbsp;
  Injector.prototype.get = <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >    if (name == "$scope") <span class="cstat-no" title="statement not covered" >return new infer.Obj(globalInclude("$rootScope").getType(), "$scope");</span></span>
<span class="cstat-no" title="statement not covered" >    if (name in this.fields) <span class="cstat-no" title="statement not covered" >return this.fields[name];</span></span>
<span class="cstat-no" title="statement not covered" >    var field = this.fields[name] = new infer.AVal;</span>
<span class="cstat-no" title="statement not covered" >    return field;</span>
  };
  Injector.prototype.set = <span class="fstat-no" title="function not covered" >function(name, val, doc, node, depth) {</span>
<span class="cstat-no" title="statement not covered" >    if (name == "$scope" || depth &amp;&amp; depth &gt; 10) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >    var field = this.fields[name] || (this.fields[name] = new infer.AVal);</span>
<span class="cstat-no" title="statement not covered" >    if (!depth) <span class="cstat-no" title="statement not covered" >field.local = true;</span></span>
<span class="cstat-no" title="statement not covered" >    if (!field.origin) <span class="cstat-no" title="statement not covered" >field.origin = infer.cx().curOrigin;</span></span>
<span class="cstat-no" title="statement not covered" >    if (typeof node == "string" &amp;&amp; !field.span) <span class="cstat-no" title="statement not covered" >field.span = node;</span></span>
    else <span class="cstat-no" title="statement not covered" >if (node &amp;&amp; typeof node == "object" &amp;&amp; !field.originNode) <span class="cstat-no" title="statement not covered" >field.originNode = node;</span></span>
<span class="cstat-no" title="statement not covered" >    if (doc) { <span class="cstat-no" title="statement not covered" >field.doc = doc; <span class="cstat-no" title="statement not covered" ></span>field.propagate(new SetDoc(doc)); </span>}</span>
<span class="cstat-no" title="statement not covered" >    val.propagate(field);</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; this.forward.length; ++i)</span>
<span class="cstat-no" title="statement not covered" >      this.forward[i].set(name, val, doc, node, (depth || 0) + 1);</span>
  };
  Injector.prototype.forwardTo = <span class="fstat-no" title="function not covered" >function(injector) {</span>
<span class="cstat-no" title="statement not covered" >    this.forward.push(injector);</span>
<span class="cstat-no" title="statement not covered" >    for (var field in this.fields) {</span>
<span class="cstat-no" title="statement not covered" >      var val = this.fields[field];</span>
<span class="cstat-no" title="statement not covered" >      injector.set(field, val, val.doc, val.span || val.originNode, 1);</span>
    }
  };
&nbsp;
<span class="fstat-no" title="function not covered" >  function globalInclude(name) {</span>
<span class="cstat-no" title="statement not covered" >    var service = infer.cx().definitions.angular.service;</span>
<span class="cstat-no" title="statement not covered" >    if (service.hasProp(name)) <span class="cstat-no" title="statement not covered" >return service.getProp(name);</span></span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function getInclude(mod, name) {</span>
<span class="cstat-no" title="statement not covered" >    var glob = globalInclude(name);</span>
<span class="cstat-no" title="statement not covered" >    if (glob) <span class="cstat-no" title="statement not covered" >return glob;</span></span>
<span class="cstat-no" title="statement not covered" >    if (!mod.injector) <span class="cstat-no" title="statement not covered" >return infer.ANull;</span></span>
<span class="cstat-no" title="statement not covered" >    return mod.injector ? mod.injector.get(name) : infer.ANull;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function applyWithInjection(mod, fnType, node, asNew) {</span>
<span class="cstat-no" title="statement not covered" >    var deps = [];</span>
<span class="cstat-no" title="statement not covered" >    if (/FunctionExpression/.test(node.type)) {</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; node.params.length; ++i)</span>
<span class="cstat-no" title="statement not covered" >        deps.push(getInclude(mod, node.params[i].name));</span>
    } else <span class="cstat-no" title="statement not covered" >if (node.type == "ArrayExpression") {</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; node.elements.length - 1; ++i) {</span>
...
<span class="cstat-no" title="statement not covered" >          deps.push(getInclude(mod, elt.value));</span>
        else
<span class="cstat-no" title="statement not covered" >          deps.push(infer.ANull);</span>
      }
<span class="cstat-no" title="statement not covered" >      var last = node.elements[node.elements.length - 1];</span>
<span class="cstat-no" title="statement not covered" >      if (last &amp;&amp; /FunctionExpression/.test(last.type))</span>
<span class="cstat-no" title="statement not covered" >        fnType = last.scope.fnType;</span>
    }
<span class="cstat-no" title="statement not covered" >    var result = new infer.AVal;</span>
<span class="cstat-no" title="statement not covered" >    if (asNew) {</span>
<span class="cstat-no" title="statement not covered" >      var self = new infer.AVal;</span>
<span class="cstat-no" title="statement not covered" >      fnType.propagate(new infer.IsCtor(self));</span>
<span class="cstat-no" title="statement not covered" >      self.propagate(result, 90);</span>
<span class="cstat-no" title="statement not covered" >      fnType.propagate(new infer.IsCallee(self, deps, null, new infer.IfObj(result)));</span>
    } else {
<span class="cstat-no" title="statement not covered" >      fnType.propagate(new infer.IsCallee(infer.cx().topScope, deps, null, result));</span>
    }
<span class="cstat-no" title="statement not covered" >    return result;</span>
  }
&nbsp;
  infer.registerFunction("angular_callInject", <span class="fstat-no" title="function not covered" >function(argN) {</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function(self, args, argNodes) {</span></span>
<span class="cstat-no" title="statement not covered" >      var mod = self.getType();</span>
<span class="cstat-no" title="statement not covered" >      if (mod &amp;&amp; argNodes &amp;&amp; argNodes[argN])</span>
<span class="cstat-no" title="statement not covered" >        applyWithInjection(mod, args[argN], argNodes[argN]);</span>
    };
  });
&nbsp;
  infer.registerFunction("angular_regFieldCall", <span class="fstat-no" title="function not covered" >function(self, args, argNodes) {</span>
<span class="cstat-no" title="statement not covered" >    var mod = self.getType();</span>
<span class="cstat-no" title="statement not covered" >    if (mod &amp;&amp; argNodes &amp;&amp; argNodes.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      var result = applyWithInjection(mod, args[1], argNodes[1]);</span>
<span class="cstat-no" title="statement not covered" >      if (mod.injector &amp;&amp; argNodes[0].type == "Literal")</span>
<span class="cstat-no" title="statement not covered" >        mod.injector.set(argNodes[0].value, result, argNodes[0].angularDoc, argNodes[0]);</span>
    }
  });
&nbsp;
  infer.registerFunction("angular_regFieldNew", <span class="fstat-no" title="function not covered" >function(self, args, argNodes) {</span>
<span class="cstat-no" title="statement not covered" >    var mod = self.getType();</span>
<span class="cstat-no" title="statement not covered" >    if (mod &amp;&amp; argNodes &amp;&amp; argNodes.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      var result = applyWithInjection(mod, args[1], argNodes[1], true);</span>
<span class="cstat-no" title="statement not covered" >      if (mod.injector &amp;&amp; argNodes[0].type == "Literal")</span>
<span class="cstat-no" title="statement not covered" >        mod.injector.set(argNodes[0].value, result, argNodes[0].angularDoc, argNodes[0]);</span>
    }
  });
&nbsp;
  infer.registerFunction("angular_regField", <span class="fstat-no" title="function not covered" >function(self, args, argNodes) {</span>
<span class="cstat-no" title="statement not covered" >    var mod = self.getType();</span>
<span class="cstat-no" title="statement not covered" >    if (mod &amp;&amp; mod.injector &amp;&amp; argNodes &amp;&amp; argNodes[0] &amp;&amp; argNodes[0].type == "Literal" &amp;&amp; args[1])</span>
<span class="cstat-no" title="statement not covered" >      mod.injector.set(argNodes[0].value, args[1], argNodes[0].angularDoc, argNodes[0]);</span>
  });
&nbsp;
<span class="fstat-no" title="function not covered" >  function arrayNodeToStrings(node) {</span>
<span class="cstat-no" title="statement not covered" >    var strings = [];</span>
<span class="cstat-no" title="statement not covered" >    if (node &amp;&amp; node.type == "ArrayExpression")</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; node.elements.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        var elt = node.elements[i];</span>
<span class="cstat-no" title="statement not covered" >        if (elt.type == "Literal" &amp;&amp; typeof elt.value == "string")</span>
<span class="cstat-no" title="statement not covered" >          strings.push(elt.value);</span>
      }
<span class="cstat-no" title="statement not covered" >    return strings;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function moduleProto(cx) {</span>
<span class="cstat-no" title="statement not covered" >    var ngDefs = cx.definitions.angular;</span>
<span class="cstat-no" title="statement not covered" >    return ngDefs &amp;&amp; ngDefs.Module.getProp("prototype").getType();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function declareMod(name, includes) {</span>
<span class="cstat-no" title="statement not covered" >    var cx = infer.cx(), data = cx.parent.mod.angular;</span>
<span class="cstat-no" title="statement not covered" >    var proto = moduleProto(cx);</span>
<span class="cstat-no" title="statement not covered" >    var mod = new infer.Obj(proto || true);</span>
<span class="cstat-no" title="statement not covered" >    if (!proto) <span class="cstat-no" title="statement not covered" >data.nakedModules.push(mod);</span></span>
<span class="cstat-no" title="statement not covered" >    mod.origin = cx.curOrigin;</span>
<span class="cstat-no" title="statement not covered" >    mod.injector = new Injector();</span>
<span class="cstat-no" title="statement not covered" >    mod.metaData = {includes: includes};</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; includes.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var depMod = data.modules[includes[i]];</span>
<span class="cstat-no" title="statement not covered" >      if (!depMod)</span>
<span class="cstat-no" title="statement not covered" >        (data.pendingImports[includes[i]] || (data.pendingImports[includes[i]] = [])).push(mod.injector);</span>
      else <span class="cstat-no" title="statement not covered" >if (depMod.injector)</span>
<span class="cstat-no" title="statement not covered" >        depMod.injector.forwardTo(mod.injector);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (typeof name == "string") {</span>
<span class="cstat-no" title="statement not covered" >      data.modules[name] = mod;</span>
<span class="cstat-no" title="statement not covered" >      var pending = data.pendingImports[name];</span>
<span class="cstat-no" title="statement not covered" >      if (pending) {</span>
<span class="cstat-no" title="statement not covered" >        delete data.pendingImports[name];</span>
<span class="cstat-no" title="statement not covered" >        for (var i = 0; i &lt; pending.length; ++i)</span>
<span class="cstat-no" title="statement not covered" >          mod.injector.forwardTo(pending[i]);</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    return mod;</span>
  }
&nbsp;
  infer.registerFunction("angular_module", <span class="fstat-no" title="function not covered" >function(_self, _args, argNodes) {</span>
<span class="cstat-no" title="statement not covered" >    var mod, name = argNodes &amp;&amp; argNodes[0] &amp;&amp; argNodes[0].type == "Literal" &amp;&amp; argNodes[0].value;</span>
<span class="cstat-no" title="statement not covered" >    if (typeof name == "string")</span>
<span class="cstat-no" title="statement not covered" >      mod = infer.cx().parent.mod.angular.modules[name];</span>
<span class="cstat-no" title="statement not covered" >    if (!mod)</span>
<span class="cstat-no" title="statement not covered" >      mod = declareMod(name, arrayNodeToStrings(argNodes &amp;&amp; argNodes[1]));</span>
<span class="cstat-no" title="statement not covered" >    return mod;</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.target.addType(new infer.Fn(tp.name, tp.self, tp.args.slice(this.args.length),</span>
...
&nbsp;
  infer.registerFunction("angular_bind", <span class="fstat-no" title="function not covered" >function(_self, args) {</span>
<span class="cstat-no" title="statement not covered" >    if (args.length &lt; 2) <span class="cstat-no" title="statement not covered" >return infer.ANull;</span></span>
<span class="cstat-no" title="statement not covered" >    var result = new infer.AVal;</span>
<span class="cstat-no" title="statement not covered" >    args[1].propagate(new IsBound(args[0], args.slice(2), result));</span>
<span class="cstat-no" title="statement not covered" >    return result;</span>
  });
&nbsp;
<span class="fstat-no" title="function not covered" >  function postParse(ast, text) {</span>
...
<span class="cstat-no" title="statement not covered" >          var before = comment.commentsBefore(text, node.callee.property.start - 1);</span>
<span class="cstat-no" title="statement not covered" >          if (before) {</span>
<span class="cstat-no" title="statement not covered" >            var first = before[0], dot = first.search(/\.\s/);</span>
<span class="cstat-no" title="statement not covered" >            if (dot &gt; 5) <span class="cstat-no" title="statement not covered" >first = first.slice(0, dot + 1);</span></span>
<span class="cstat-no" title="statement not covered" >            first = first.trim().replace(/\s*\n\s*\*\s*|\s{1,}/g, " ");</span>
<span class="cstat-no" title="statement not covered" >            node.arguments[0].angularDoc = first;</span>
          }
        }
      }
    });
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function postLoadDef(json) {</span>
<span class="cstat-no" title="statement not covered" >    var cx = infer.cx(), defName = json["!name"], defs = cx.definitions[defName];</span>
<span class="cstat-no" title="statement not covered" >    if (defName == "angular") {</span>
<span class="cstat-no" title="statement not covered" >      var proto = moduleProto(cx), naked = cx.parent.mod.angular.nakedModules;</span>
<span class="cstat-no" title="statement not covered" >      if (proto) <span class="cstat-no" title="statement not covered" >for (var i = 0; i &lt; naked.length; ++i) <span class="cstat-no" title="statement not covered" >naked[i].proto = proto;</span></span></span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    var mods = defs &amp;&amp; defs["!ng"];</span>
...
<span class="cstat-no" title="statement not covered" >      var obj = mods.props[name].getType();</span>
<span class="cstat-no" title="statement not covered" >      var mod = declareMod(name.replace(/`/g, "."), obj.metaData &amp;&amp; obj.metaData.includes || []);</span>
<span class="cstat-no" title="statement not covered" >      mod.origin = defName;</span>
<span class="cstat-no" title="statement not covered" >      for (var prop in obj.props) {</span>
<span class="cstat-no" title="statement not covered" >        var val = obj.props[prop], tp = val.getType();</span>
<span class="cstat-no" title="statement not covered" >        if (!tp) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >        if (/^_inject_/.test(prop)) {</span>
<span class="cstat-no" title="statement not covered" >          if (!tp.name) <span class="cstat-no" title="statement not covered" >tp.name = prop.slice(8);</span></span>
<span class="cstat-no" title="statement not covered" >          mod.injector.set(prop.slice(8), tp, val.doc, val.span);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          obj.props[prop].propagate(mod.defProp(prop));</span>
        }
      }
    }
  }
...
<span class="cstat-no" title="statement not covered" >    var mods = infer.cx().parent.mod.angular.modules;</span>
<span class="cstat-no" title="statement not covered" >    var modObj = new infer.Obj(null), found = 0;</span>
...
<span class="cstat-no" title="statement not covered" >      if (state.origins.indexOf(mod.origin) &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >        var propName = name.replace(/\./g, "`");</span>
<span class="cstat-no" title="statement not covered" >        modObj.defProp(propName).addType(mod);</span>
<span class="cstat-no" title="statement not covered" >        mod.condenseForceInclude = true;</span>
<span class="cstat-no" title="statement not covered" >        ++found;</span>
<span class="cstat-no" title="statement not covered" >        if (mod.injector) <span class="cstat-no" title="statement not covered" >for (var inj in mod.injector.fields) {</span></span>
<span class="cstat-no" title="statement not covered" >          var field = mod.injector.fields[inj];</span>
<span class="cstat-no" title="statement not covered" >          if (field.local) <span class="cstat-no" title="statement not covered" >state.roots["!ng." + propName + "._inject_" + inj] = field;</span></span>
        }
      }
    }
<span class="cstat-no" title="statement not covered" >    if (found) <span class="cstat-no" title="statement not covered" >state.roots["!ng"] = modObj;</span></span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function postCondenseReach(state) {</span>
<span class="cstat-no" title="statement not covered" >    var mods = infer.cx().parent.mod.angular.modules;</span>
...
<span class="cstat-no" title="statement not covered" >      if (m = path.match(/^!ng\.([^\.]+)\._inject_([^\.]+)^/)) {</span>
<span class="cstat-no" title="statement not covered" >        var mod = mods[m[1].replace(/`/g, ".")];</span>
<span class="cstat-no" title="statement not covered" >        var field = mod.injector.fields[m[2]];</span>
<span class="cstat-no" title="statement not covered" >        var data = state.types[path];</span>
<span class="cstat-no" title="statement not covered" >        if (field.span) <span class="cstat-no" title="statement not covered" >data.span = field.span;</span></span>
<span class="cstat-no" title="statement not covered" >        if (field.doc) <span class="cstat-no" title="statement not covered" >data.doc = field.doc;</span></span>
      }
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function initServer(server) {</span>
<span class="cstat-no" title="statement not covered" >    server.mod.angular = {</span>
...
&nbsp;
  tern.registerPlugin("angular", <span class="fstat-no" title="function not covered" >function(server) {</span>
<span class="cstat-no" title="statement not covered" >    initServer(server);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    server.on("reset", <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >initServer(server); </span>});</span>
<span class="cstat-no" title="statement not covered" >    server.on("postParse", postParse)</span>
...
<span class="cstat-no" title="statement not covered" >    server.on("postCondenseReach", postCondenseReach)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    server.addDefs(defs, true)</span>
  });
&nbsp;
  var defs = {
    "!name": "angular",
